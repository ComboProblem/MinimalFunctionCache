...
export SAMPLE_SIZE=2 # increasing sample size increases the inital run time which could lenghtly wiht current implementation.
...
cd ~/MinimalFunctionCache/MinimalFunctionCacheGen/
python3 cache_job_setup.py $NUM_BKPT $SAMPLE_SIZE $TIME_PER_BATCH $MAX_NUM_ROW $MAX_STD $BACKEND
